        ...
        def work(self):
                ...
                try:
                        while True:
                                ...
                                a,b,c,d = p.getInt(),p.getInt(),p.getInt(),p.getInt()
                                ...
                                def inner():
                                        try:
                                                self.result = SilverDistance.minSteps(copy.copy(a),copy.copy(b),copy.copy(c),copy.copy(d))
                                ...
                                if not self.done or not self.resultReturned or not self.typeOk:
                                        ...
                                        sprinter.write(str(a)+' '); sprinter.write(str(b)+' '); sprinter.write(str(c)+' '); sprinter.write(str(d)+' '); 
