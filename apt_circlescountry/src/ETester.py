        ...
        def work(self):
                ...
                try:
                        while True:
                                ...
                                a,b,c,d,e,f,g = p.parseVI(),p.parseVI(),p.parseVI(),p.getInt(),p.getInt(),p.getInt(),p.getInt()
                                ...
                                def inner():
                                        try:
                                                self.result = CirclesCountry.leastBorders(copy.copy(a),copy.copy(b),copy.copy(c),copy.copy(d),copy.copy(e),copy.copy(f),copy.copy(g))
                                ...
                                if not self.done or not self.resultReturned or not self.typeOk:
                                        ...
                                        sprinter.write(str(a)+' '); sprinter.write(str(b)+' '); sprinter.write(str(c)+' '); sprinter.write(str(d)+' '); sprinter.write(str(e)+' '); sprinter.write(str(f)+' '); sprinter.write(str(g)+' '); 
